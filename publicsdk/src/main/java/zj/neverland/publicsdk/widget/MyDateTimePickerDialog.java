 ...
 * 日期 选择 器
 */
public class MyDateTimePickerDialog extends AlertDialog implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener, TimePicker.OnTimeChangedListener, DatePicker.OnDateChangedListener, View.OnClickListener {
     ...
     */
    public MyDateTimePickerDialog(Context context, MyOnDateSetListener myOnDateSetListener) {
     ...
     * @param myOnDateSetListener 监听器
     */
    public MyDateTimePickerDialog(Context context, Date date, MyOnDateSetListener myOnDateSetListener) {
        super(context);
        this.date = date;
