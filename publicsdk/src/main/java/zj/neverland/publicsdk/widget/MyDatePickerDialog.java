...
public class MyDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public MyDatePickerDialog(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth,boolean isShowDay) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth,isShowDay);
    }


    public MyDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                              int dayOfMonth,boolean isShowDay) {
        super(context, theme);
        ...
        View view = inflater.inflate(R.layout.layout_date_year_month, null);
        setView(view);
