...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Builder builder) {
        ...
        if (customListener == null) {
            LayoutInflater.from(builder.context).inflate(R.layout.pickerview_time, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? builder.context.getResources().getString(R.string.pickerview_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? builder.context.getResources().getString(R.string.pickerview_cancel) : Str_Cancel);
            ...
            customListener.customLayout(LayoutInflater.from(builder.context).inflate(layoutRes, contentContainer));
        }
        // 时间转轮 自定义控件
